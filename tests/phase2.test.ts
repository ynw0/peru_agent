...
test("AI IDE Workbench 历史容器位置保持稳定", () => {
  ...
  assert.equal(locations.get("independentAiIde.evolution"), "activityBar");
  assert.equal(locations.get("independentAiIde.release"), "activityBar");
